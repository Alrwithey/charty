    ...
    <div class="admin-wrapper">
        <aside class="sidebar">
            ...
            <ul>
                ...
                <li><a href="manage_sliders.php" class="<?php if($current_page == 'manage_sliders.php' || $current_page == 'edit_slider.php') echo 'active'; ?>"><i class="fas fa-images"></i> البنر المتحرك</a></li>
                <hr style="border-color: rgba(255,255,255,0.1); margin: 10px 0;">
                <li><a href="manage_pages.php" class="<?php if(in_array($current_page, ['manage_pages.php', 'edit_page.php'])) echo 'active'; ?>"><i class="fas fa-file-alt"></i> الصفحات التعريفية</a></li>
                <li><a href="manage_board.php" class="<?php if($current_page == 'manage_board.php') echo 'active'; ?>"><i class="fas fa-users"></i> مجلس الإدارة</a></li>
                <li><a href="manage_assembly.php" class="<?php if($current_page == 'manage_assembly.php') echo 'active'; ?>"><i class="fas fa-user-friends"></i> الجمعية العمومية</a></li>
                <hr style="border-color: rgba(255,255,255,0.1); margin: 10px 0;">
                ...
                <hr style="border-color: rgba(255,255,255,0.1); margin: 10px 0;">
                <li><a href="manage_users.php" class="<?php if(in_array($current_page, ['manage_users.php', 'edit_user.php'])) echo 'active'; ?>"><i class="fas fa-users-cog"></i> إدارة المستخدمين</a></li>
